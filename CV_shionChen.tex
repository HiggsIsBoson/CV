...
I have pursued the fundamental theories of quantum mechanics and elementary particle physics using the platform of high energy physics, or somtimes vice versa.
The topics include:
\begin{itemize}		
...
From 2022 moving back to ICEPP/UTokyo, I also joined the looming quantum hardware team in the institute.
The scope spans from developing quantum devices for superconducting NISQ machines, 
high-Q cavity application for quantum memory and transduction,
to introduction of qubits to haloscope experiments targeting wave-like dark matter such as dark photon or axion.
The initiation efforts include the establishing the fabrication of the own superconducting qubits or the peripheral devies (cavities, PCBs etc.),
and the low-temperature measurement setup in the Mili-kelvin Quantum Platform of Cryogenic Research Center at The University of Tokyo. \\

A new wave-like dark matter search scheme using the superconducting qubits are also deviced 
in the collaboration with phenomenologiest colleagues in the department~[\ref{Pub::DMQubits1}].
This is to use the ac E-field induced by the dark photon dark matter as the ``drive pulse'' for the qubits,
and observe the slow yet coherent excitation as the signal.
The key of element of the scheme is the large electric dipole moment of qubits as the nature of artificial atoms.
The strong coupling allows to detect very feeble electric field achiving a promising sensitivity.
The easy frequency tunability of the qubuts also enables the mass scan without significant engineering efforts, 
...
The DAQ team has been awarded for the ATLAS Outstanding Achievement Award for the overall efforts in 2018-20. 
...
In 2013, I was involved in the commissioning using the test board for my summer student project at DESY. \\
...
While quantum mechanics (QM) is without doubt a very successful theoretical framework in describing physics of the microscopic scale, 
...
This has been formulated as a physical problem via Bell's inequality, and its violation observed in 1970-80s using entangled photon pairs eloquently indicated the experimental exclusion of local-realism.
