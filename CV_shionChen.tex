...
upgrade of the Trigger and Timing Controller system, the hardware spare stress-testing, and the radiation damage assessment in the TRT.
...
it is still on a non-trivial basis; whether observables are intrinsically undeterministic (``non-realism'') and whether the nature can be ``non-local''. 
Such counter-intuitiveness was in fact had been considered as a problem as articulated by the ``EPR paradox''.
