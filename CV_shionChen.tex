...
However, through the confirmation of violation of Bell's inequality in 1970-80s using entangled photon pairs, the local-realism was experimentally excluded.
...
So is there anything still left to do in the post-ERP era? Yes -- experiments in the other kind of systems are also interesting in terms of testing the universality of quantum nature. 
...
The (iso)spin can be then measured by reconstructing the decay angle distribution of the decay products.
The down-side is the nature of indirect measurements i.e. the (iso)spin can only be measured through its decay to which observer's free-will cannot intervene (``free-will loophole'').
