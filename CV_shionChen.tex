...
OB Radiation Tracker (TRT) is one of the primary tracking detectors in the ATLAS.
...
via the transition radiation radiated emitted from the polyethelene fiber/foils interspaced between the straws. \\
