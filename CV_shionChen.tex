...
%           \href{https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/CONFNOTES/ATLAS-CONF-2021-022/}{ATLAS-CONF-2021-022} (2021)  	\label{Pub::ATLCONF_EW0L_LHCP2021}
	    Phys. Rev. D 104, 112010 (2021)  arXiv:~\href{https://arxiv.org/abs/2106.01676}{[hep-ex]~2108.07586}   \label{Pub::ATLPaper_EW0L}          
%
	\item ATLAS Collabolation \dots \underline{\textbf{S. Chen}} \dots \\
...
The analysis is also designed to target hadronically decaying $W/Z/h$ bosons inclusively.
This dramatically reduces the model dependency in the search sensitivity which previous SUSY search results often suffer from~[\ref{Pub::ATLPaper_EW0L}].
