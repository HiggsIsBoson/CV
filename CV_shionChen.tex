...
%  \begin{center}
    \begin{tabular}{ll}
      ...
      Address: &  \\ 
               & Kyoto University. \\
               & Kitashirakawa-Oiwakecho 6060851 Kyoto Japan. \\
      email: &  chen.shion.2u@kyoto-u.ac.jp \\
      phone: & +81-75-753-3861 \\
    \end{tabular}
%  \end{center}
%    \caption*{}
\end{minipage}
...
\begin{description}
	 \item[\underline{2014-2017}]   \mbox{}\\
	 	Doctor of Philosophy~(Science), The University of Tokyo, Japan. \\
...
\begin{description}
	 \item[Associated Professor] (Kyoto University, May 2024-present) \mbox{} \\
               New physics searches in ATLAS experiment, dark matter searches using superconducting quantum devices. \\
%
	 \item[Project Assistant Professor] (University of Tokyo, Jan 2022-Apr 2024) \mbox{} \\
...
%
	  \item[Research Fellow (DC1)] (Japan Society for the Promotion of Science, April 2014 - March 2017).
\end{description}
%\clearpage
...
%
	\item ATLAS Collaboration \dots \underline{\textbf{S.~Chen}} \dots \\
            ...
            JINST. \textbf{19} P05063 (2024), arXiv:~\href{https://arxiv.org/abs/2305.16623}{[hep-ex]~2305.16623}. \label{Pub::ATLPaper_Run3Detector}
\end{enumerate}


%%%%%%%%%%%%%%%%%%%%%%% Talks at Confereces %%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\Section{Selected Conference Talks  \hrule height 0.5mm depth 1mm width 100mm} \vspace{-5mm}
\begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%% Grants & Awards %%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\Section{Competitive interships and Awards \hrule height 0.5mm depth 1mm width 100mm} \vspace{-5mm}
\begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%% Grants & Awards %%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
%\Section{Research Grants \hrule height 0.5mm depth 1mm width 100mm} \vspace{-5mm}
%\begin{enumerate}
%\item Research Fellow (DC1), Japan Society for the Promotion of Science (April 2014 - March 2017).
%\item 
%\item
